                ...
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            ...
                            if(ProductDetailsActivity.addToWishlistBtn != null) {
                                ProductDetailsActivity.addToWishlistBtn.setSupportImageTintList(context.getResources().getColorStateList(R.color.secondaryDark));
                            }
                                                        ...
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            for (DocumentSnapshot orderItems : task.getResult().getDocuments()) {
                                                                ...
                                                                MyOrderItemModel myOrderItemModel = new MyOrderItemModel(
                                                                        ...
                                                                        , (Timestamp) orderItems.get("Ordered Date")
                                                                        , (Timestamp) orderItems.get("Packed Date")
                                                                        , (Timestamp) orderItems.get("Shipped Date")
                                                                        , (Timestamp) orderItems.get("Delivered Date")
                                                                        , (Timestamp) orderItems.get("Cancelled Date")
