...
import com.example.ecommerce.ui.my_account.MyAccountFragment;
import com.example.ecommerce.ui.my_cart.MyCartFragment;
import com.example.ecommerce.ui.my_mall.MyMallFragment;
import com.example.ecommerce.ui.my_orders.MyOrdersFragment;
import com.example.ecommerce.ui.my_rewards.MyRewardsFragment;
import com.example.ecommerce.ui.my_wishlist.MyWishlistFragment;
...
import static com.example.ecommerce.RegisterActivity.setsignUpFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button signInDialogBtn=signInDialog.findViewById(R.id.update_pass_btn);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        if(currentFragment== MyMallFragment){
            ...
            getSupportActionBar().setDisplayHomeAsUpEnabled(true);
            getSupportActionBar().setHomeAsUpIndicator(drawable.ic_hamburger);
            ...
            badgeIcon.setImageResource(drawable.ic_cart_icon);
            ...
            badgeeIcon.setImageResource(drawable.ic_bell);
    ...
    private void setFragment(Fragment fragment,int fragementNo){
        if(fragementNo!=currentFragment) {
            ...
            if(fragementNo==REWARDS_FRAGMENT){
                window.setStatusBarColor(Color.parseColor("#425A4D"));
                toolbar.setBackgroundColor(Color.parseColor("#425A4D"));
            }else {
