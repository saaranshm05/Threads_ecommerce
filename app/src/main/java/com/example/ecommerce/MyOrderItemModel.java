...
public class MyOrderItemModel {
    ...
    private Timestamp orderedDate,packedDate,shippedDate,delveredDate,cancelleddate;
    ...
    public MyOrderItemModel(String productId, String orderStatus, String address, String coupanId, String productPrice, String cuttedPrice, String discountedPrice, Timestamp orderedDate, Timestamp packedDate, Timestamp shippedDate, Timestamp delveredDate, Timestamp cancelleddate, Long freeCoupans, Long productQuantity, String fullName, String orderId, String paymentMethod, String pincode, String userId,String productTitle,String productImage,String deliveryPrice,boolean cancellationrequested) {
    ...
    public Timestamp getDelveredDate() {
        return delveredDate;
    }

    public void setDelveredDate(Timestamp delveredDate) {
        this.delveredDate = delveredDate;
    }
