...
//        cancelDialog.getWindow().setLayout(ViewGroup.LayoutParams.WRAP_CONTENT, ViewGroup.LayoutParams.WRAP_CONTENT);
        ...
        switch (model.getOrderStatus()){
            case "Ordered":
                orderedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.NeonGreen)));
            ...
            case "Packed":
                ...
                packedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.NeonGreen)));
            ...
            case "Shipped":
                shippedIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.NeonGreen)));
            ...
            case "out for Delivery":
                deliveredIndicator.setImageTintList(ColorStateList.valueOf(getResources().getColor(R.color.NeonGreen)));
        ...
        if(model.getDiscountedPrice().equals("")){
            ...
            totalItemsPrice.setText("₹"+ String.valueOf(totalPrice) +"/-");
        }else {
        ...
        if(model.getDeliveryPrice().equals("FREE")){
            ...
            totalAmount.setText("₹"+String.valueOf(totalPrice+Long.valueOf(model.getDeliveryPrice()))+"/-");
        }
